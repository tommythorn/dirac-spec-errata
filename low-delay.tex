...
\bsCODE{qindex=read\_nbits(6)}{\text{NB:shd be variable}}
\bsCODE{slice\_bits\_left -= 6}
\bsCODE{slice\_quantisers(qindex)}{\ref{slicequantisers}}
\bsCODE{slice\_y\_length=read\_nbits(9)}{\text{NB:shd be variable}}
\bsCODE{slice\_bits\_left -= 9}
