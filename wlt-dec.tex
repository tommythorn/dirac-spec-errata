...
\bsIF{zero\_flag()}{\ref{zeroblockflag}}
  \bsFOR{v=bottom}{top-1}
    \bsFOR{h=left}{right-1}
      \bsCODE{data[level][orient][v][h] = 0}
    \bsEND
  \bsEND
\bsELSE
  ...
  \bsFOR{v=bottom}{top-1}
    \bsFOR{h=left}{right-1}
      \bsCODE{coeff\_decode(data,level,orient,quant_idx,v,h)}{\ref{wltcoeff}}
    \bsEND
  \bsEND
...
\begin{pseudo}{coeff\_decode}{data,level,orient,quant\_index,v,h}
