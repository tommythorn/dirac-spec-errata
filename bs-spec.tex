...
\bsCODE{color\_spec(\VideoParams)}{\ref{colorspec}}
\bsRET{\VideoParams}
\end{pseudo}
...
\bsITEM{custom\_color\_spec\_flag}{bool}{}
\bsIF{custom\_color\_spec\_flag==\true}
    \bsITEM{index}{uint}{}
    \bsCODE{preset\_color\_specs(\VideoParams,index)}
    \bsIF{index == 0}
        \bsCODE{color\_primaries(\VideoParams)}{\ref{colorprimaries}}
        \bsCODE{color\_matrix(\VideoParams)}{\ref{colormatrix}}
...
\bsITEM{custom\_color\_primaries\_flag}{bool}{}
\bsIF{custom\_color\_primaries\_flag==\true}
    \bsITEM{index}{uint}{}
    \bsCODE{preset\_color\_primaries(\VideoParams,index)}
\bsEND
\end{pseudo}
...
\bsITEM{color\_matrix\_flag}{bool}{}
\bsIF{color\_matrix\_flag==\true}
    \bsITEM{index}{uint}{}
    \bsCODE{preset\_color\_matrices(index)}
\bsEND
\end{pseudo}
