...
The profile determines the value of the boolean functions $using\_ac()$ and $using\_mc()$.
...
not mean that an application under Main profile is required to use Inter pictures.
