...
required to be less than a picture.
...
Auxiliary data parse units consist of a parse info header, decoded by the $parse\_info()$ function
defined in the previous section, followed by zero or more bytes of unspecified data. Auxiliary data
parse units may be interposed between any two other legitimate parse units in the stream, and
may safely be skipped by a compliant decoder. 

For the purposes of subsequent parts of this specification, the potential presence of auxiliary data is ignored. 
