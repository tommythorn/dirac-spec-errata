...
\item[Chroma:] a pair of colour difference components. The term chroma is the direct equivalent to ‘luma’ (see ‘luma’ definition below). In this specification, the term chroma is not the same as that used in composite colour television. It is used to cover both gamma-corrected and non-gamma-corrected signals.
...
\item[Luma:] the weighted sum of RGB components of colour video, which may or may not be gamma-corrected. (This term is used to prevent confusion with the term ‘luminance’ that is created only from linear light levels as used in colour science.)
