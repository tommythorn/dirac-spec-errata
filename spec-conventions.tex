...
\paragraph*{Clip} $\clip(a,b,t)$ clips the value $a$ to the range defined by $b$ (bottom)
and $t$ (top):
...
\paragraph*{Set} A collection of variables or values with no particular indexing. 
