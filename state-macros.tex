...
% To insert the sequence state variable, type \SNickName
...
\vdefine{SSourceSampling}{\text{SOURCE\_SAMPLING}}
...
\vdefine{SChromaFormatIndex}{CHROMA\_FORMAT\_INDEX}
\vdefine{SFrameRateNumer}{FRAME\_RATE\_NUMER}
\vdefine{SFrameRateDenom}{FRAME\_RATE\_DENOM}

\vdefine{SAspectRatioNumer}{PIXEL\_ASPECT\_RATIO\_NUMER}
\vdefine{SAspectRatioDenom}{PIXEL\_ASPECT\_RATIO\_DENOM}
%
...
\kdefine{ALow}{LOW}
\kdefine{ACode}{CODE}
\kdefine{ACodeMinusLow}{CODE\_MINUS\_LOW}
\kdefine{ABitsLeft}{BITS\_LEFT}
\kdefine{AContexts}{CONTEXT\_PROBS}
\kdefine{ALUT}{PROB\_LUT}
\kdefine{ACounter}{COUNTER}
...
\kdefine{XBsep}{XBSEP}
\kdefine{YBsep}{YBSEP}
\kdefine{XOffset}{XOFFSET}
\kdefine{YOffset}{YOFFSET}
\kdefine{LenX}{LEN\_X}
\kdefine{LenY}{LEN\_Y}
