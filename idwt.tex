...
\hline
\begin{tabular}{l}
1. Even, Predict, $s=8, t_{-1}=-11, t_0=36, t_1=36, t_2=-11$ i.e. \\
\quad $A[2*n] -=  (-11*A[2*n-3]+36*A[2*n-1]+36*A[2*n+1]-11*A[2*n+3]+128)\gg 8 $ \\
2. Odd, Update, $s=8, t_{-1}=-22, t_0=84, t_1=84, t_2=-22$ i.e. \\
\quad $ A[2*n+1] += (-22*A[2*n-2]+84*A[2*n]+84*A[2*n+2]-22*A[2*n+4]+128)\gg 8$ \\
3. Even, Predict, $s=8, t_{-1}=-19, t_0=85, t_1=85, t_2=-19$ i.e. \\
\quad $A[2*n] -=  (-19*A[2*n-3]+85*A[2*n-1]+85*A[2*n+1]-19*A[2*n+3]+128)\gg 8 $ \\
4. Odd, Update, $s=8, t_{-1}=-8, t_0=41, t_1=41, t_2=-8$ i.e. \\
\quad $ A[2*n+1] += (-8*A[2*n-2]+41*A[2*n]+41*A[2*n+2]-8*A[2*n+4]+128)\gg 8$
\end{tabular}
& 0 \\
\hline
