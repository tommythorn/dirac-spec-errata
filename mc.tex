...
\bsIF{\MotionVectorPrecision>0}
  \bsCODE{px = (x\ll \MotionVectorPrecision)+mv.x}
  \bsCODE{py = (y\ll \MotionVectorPrecision)+mv.y}
\bsELSE
  \bsCODE{px = (x+mv.x)<<1}
  \bsCODE{py = (y+mv.y)<<1}
\bsEND
