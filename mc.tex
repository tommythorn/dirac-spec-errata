...
$chroma\_mv\_scale()$ function. This uses unbiased rounding to produce chroma
motion vectors with the same accuracy for the chroma components as for the luma
component:

\begin{pseudo}{chroma\_mv\_scale}{v}
\bsCODE{sv[0] = \rounddivide(v[0], chroma\_h\_factor() )}{\ref{chromaformat}}
\bsCODE{sv[1] = \rounddivide(v[1], chroma\_v\_factor())}{\ref{chromaformat}}
\bsRET{sv}
\end{pseudo}
