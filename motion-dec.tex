...
\bsELSE
    \bsCODE{num\_ref1\_nbrs=\BlockData[y-1][x] \& 1}
    \bsCODE{num\_ref1\_nbrs +=\BlockData[y-1][x-1] \& 1}
    \bsCODE{num\_ref1\_nbrs +=\BlockData[y][x-1] \& 1}
    \bsCODE{pred=num\_ref1\_nbrs//2}    
    \bsCODE{num\_ref2\_nbrs=(\BlockData[y-1][x]\gg 1) \& 1}
    \bsCODE{num\_ref2\_nbrs +=(\BlockData[y-1][x-1] \gg 1) \& 1}
    \bsCODE{num\_ref2\_nbrs +=(\BlockData[y][x-1] \gg 1) \& 1}
