...
then a block will either be intra or will use global motion compensation according to the block mode, and for non-intra blocks a flag is decoded indicating whether this is so. If
