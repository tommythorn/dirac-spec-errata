...
[To do: Say sthg about superblock split array]
...
\bsCODE{\SBSplit[ypos][xpos]=read\_uinta(sb\_split\_contexts() ) }
...
\bsCODE{\BlockData[ypos][xpos][mode][1] = read\_boola(\PredModeOne)}
\bsCODE{\BlockData[ypos][xpos][mode][1] \hat= mode\_prediction(ypos, xpos, 1)}{\ref{modeprediction}}
\bsIF{\NumRefs == 2}
    \bsCODE{\BlockData[ypos][xpos][mode][2] = read\_boola(\PredModeOne)}
...
\begin{pseudo}{block\_mode}{ypos, xpos}
\bsCODE{\BlockData[ypos][xpos][global] = read\_boola(\BlockGlobal)}
...
\bsIF{\BlockData[ypos][xpos][mode][1] == \true}
    \bsCODE{\BlockData[ypos][xpos][ref1].x = read\_sinta(ref1x\_contexts() ) }{\ref{mvcontexts}}
    \bsCODE{\BlockData[ypos][xpos][ref1].y = read\_sinta(ref1y\_contexts() ) }{\ref{mvcontexts}}
    \bsCODE{\BlockData[ypos][xpos][ref1] += mv\_prediction(ypos, xpos, 1)}
\bsEND
\bsIF{\BlockData[ypos][xpos][mode][2] == \true}
    \bsCODE{\BlockData[ypos][xpos][ref2].x = read\_sinta(ref2x\_contexts() ) }{\ref{mvcontexts}}
    \bsCODE{\BlockData[ypos][xpos][ref2].y = read\_sinta(ref2y\_contexts() ) }{\ref{mvcontexts}}
...
\begin{pseudo}{block\_motion}{ypos, xpos}
\bsFOREACH{c}{Y,U,V}
    \bsCODE{\BlockData[ypos][xpos][dc][c] = read\_sinta(dc\_contexts(c)) }{\ref{dcvaluecontexts}}
...
Motion vectors are predicted using the median of available vectors in the aperture. The
